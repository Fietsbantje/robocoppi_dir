...
# It doesn't seem to get beyond this step (script works up to line 101). I went back to the 101 tutorials:) and changed to vs code. After getting really confused by installation of packages and the different Python versions on Mac and trying the following: Installed 'Random Everything' (in Sublime Text) and 'Anaconda', as PIP connecting to 1 Python only situation (1 error message to solve left), no change.
